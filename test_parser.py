...
@pytest.fixture
@given(csv_test=csv_st(columns=[st.integers(min_value=1, max_value=5), st.integers(min_value=1, max_value=5), st.integers(min_value=1, max_value=5)], lines=20),
       csv_training=csv_st(columns=[st.integers(min_value=1, max_value=20), st.integers(min_value=1, max_value=10), st.integers(min_value=1, max_value=5)], lines=100))
